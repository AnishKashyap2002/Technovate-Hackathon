export const timelineArr = [
    ...
    {
        title: "Iron Man arose",
        data: "Iron Man 1 follows the transformation of billionaire playboy Tony Stark from arrogant arms dealer to armored superhero. After a near-fatal attack in Afghanistan leaves him critically injured with shrapnel lodged near his heart, Tony is captured by a terrorist group. To escape, he builds a mechanized suit of armor using salvaged materials. This suit not only keeps him alive but also becomes a powerful weapon. As Tony refines his creation, he undergoes a personal transformation. He witnesses the devastating impact of his weapons firsthand and vows to use his technology for good.  The film culminates in a thrilling showdown where Tony, christened Iron Man, confronts the very forces he once supplied with weapons. Iron Man 1 marked the beginning of the Marvel Cinematic Universe and established Robert Downey Jr. as the iconic Iron Man.",
        image: "/timeline/5im.jpg",
        date: "2008",
    },
    {
        title: "Hulk appeared",
        data: "The Incredible Hulk picks up where a previous, unseen incident transformed scientist Bruce Banner into a raging green behemoth. On the run and wrestling with guilt, Bruce desperately seeks a cure for his condition, the Hulk emerging whenever his anger spikes.  He finds solace and assistance from his estranged girlfriend Betty Ross, but their reunion is short-lived. General Ross, Betty's father, views the Hulk as a weapon and launches a relentless pursuit. Bruce must not only control his inner monster but also contend with Emil Blonsky, a soldier who undergoes a similar transformation with monstrous results.  The film becomes a high-octane chase and battle royale, culminating in a showdown between the Hulk and the Abomination, Blonsky's monstrous form.  The Incredible Hulk, while not a traditional origin story, delves into the complexities of Bruce Banner's struggle – the yearning for a normal life constantly threatened by the uncontrollable power of the Hulk.",
        image: "/timeline/",
        date: "",
    },
    {
