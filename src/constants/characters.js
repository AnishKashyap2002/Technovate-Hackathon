export const characterArr = [
...

    {
        ...
        real_name: "Drax",
        img: "/characters/drax.png",
        description:
            "Drax the Destroyer is a member of the Guardians of the Galaxy. He is a vengeful warrior seeking to avenge the death of his family at the hands of the intergalactic villain, Thanos. Drax possesses superhuman strength and durability, making him a formidable ally in battle.",
...

    {
        ...
        description:
            "Rocket Raccoon is a member of the Guardians of the Galaxy. He is a genetically engineered raccoon with a talent for engineering, piloting, and weapons. Rocket is known for his sarcastic wit and love of explosives, often serving as the team's mechanic and tactician.",
...

    {
        name: "Groot",
        real_name: "Groot",
        img: "/characters/groot.png",
        description:
            "Groot is a member of the Guardians of the Galaxy. He is a sentient tree-like creature from the planet X, with the ability to regenerate and manipulate his body. Groot is known for his limited vocabulary, consisting mostly of the phrase 'I am Groot,' and his unwavering loyalty to his friends.",
